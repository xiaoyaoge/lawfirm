                    ...
                    <div class="cont">
                        ...
                        <form class="bk-form" id="validate_form" method="POST" action="javascript:;">
                            ...
                            <div class="bk-form-item mt5">
                                ...
                                <div class="bk-form-content">
                                    <el-popover ref="popover1" placement="right" :title="orderDeliveryInfo.templateName" width="300" trigger="hover" :content="orderDeliveryInfo.templateContent">
                                    </el-popover>
    ...
    data() {
        return {
            ...
            form: {
                ...
                hours: '', //提交时间
                orderState: '', //当前状态
                orderType: 10, // msg:10,email:20,纸质:30
                userType: 1, //订单来源 
            },
            collapsed: true,
            table: {
