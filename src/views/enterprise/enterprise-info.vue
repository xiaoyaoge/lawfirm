        ...
        <div class="info">
            <div class="bk-panel-body p25 cont">
                ...
                <div class="bk-form">
                    ...
                    <div v-show="!formEdit" class="bk-form-item mt5">
                ...
                <form class="bk-form" id="validate_form" method="POST" action="javascript:;">
                    ...
                    <div class="bk-form-item mt5">
                        ...
                        <div class="bk-form-content">
                            ...
                            <span v-else class="ml10">{{CodeToText[registerAddress[0]]}}{{CodeToText[registerAddress[1]]}}{{CodeToText[registerAddress[2]]}}</span>
                            <input type="text" class="bk-form-input" placeholder="请输入详细地址" v-model="form.registerAddress" :readonly="formEdit">
                        </div>
                    </div>
                    <div class="bk-form-item mt5">
                        ...
                        <div class="bk-form-content">
                            ...
                            <span v-else class="ml10">{{CodeToText[address[0]]}}{{CodeToText[address[1]]}}{{CodeToText[address[2]]}}</span>
                            <input type="text" class="bk-form-input" name="" placeholder="请输入详细地址：" v-model="form.address" :readonly="formEdit">
                        </div>
                    </div>
                    <div class="bk-form-item mt5">
                ...
                <div class="b-manage-title">
                    ...
                    <div class="edit-btns b-manage-btns fr">
                        <!-- 交互说明 
                             点击修改后，把保存于取消按钮显示出来，同时把info里所有input 的 readonly 去除
                        -->
                        <a v-show="balanceEditBtn" class="bk-button bk-primary bk-button-small ml10 fr" @click="balanceEditIonf('edit')" title="修改"><span>修改</span></a>
                        <a v-show="!balanceEdit" class="bk-button bk-success bk-button-small ml10 fr" @click="balanceSeverInfo" title="保存"><span>保存</span></a>
                        <a v-show="!balanceEdit" class="bk-button bk-default bk-button-small ml10 fr" @click="balanceEditIonf('cancel')" title="取消"><span>取消</span></a>
                    </div>
                </div>
                <form class="bk-form" id="validate_form" method="POST" action="javascript:;">
                    <div class="bk-form-item mt5">
                        ...
                        <div class="bk-form-content">
                            <input v-model="balanceInfo.smsCount" type="text" class="bk-form-input" placeholder="" :readonly="balanceEdit">
                        </div>
                    </div>
                    <div class="bk-form-item mt5">
                        <label class="bk-label">电子信函剩余次数：</label>
                        <div class="bk-form-content">
                            <input v-model="balanceInfo.emailCount" type="text" class="bk-form-input" placeholder="" :readonly="balanceEdit">
                        </div>
                    </div>
                </form>
            </div>
    ...
    methods: {
        ...
        getDataList() {
            ...
            this.$http.ajaxPost({
                ...
                this.$http.aop(res, () => {
                    let data = res.body.data.enterprise;
                    let dataBalan = res.body.data.balanceInfo;
                    delete(data.password);
                    this.form = data;
                    this.address = data.areaCode.split(',');
                    this.registerAddress = data.registerAreaCode.split(',');
                    if (res.body.data.balanceInfo) {
                        this.balanceUrl = 'balance/modify';
                    } else {
                        this.balanceUrl = 'balance/create';
                    }
                    this.balanceInfo = dataBalan || {
                        uid: data.eid, //eid  企业
                        userType: 1, //1企业
                        emailCount: 0, //电子信函
                        letterCount: 0, //纸质信函
